...
export const resources = {
    'zh-CN': {
        ...
        'bot.legacy.commentScan': '💬 评论区：已扫 {scanned} 条，发现 {found} 个文件',
        ...
        'bot.legacy.commentsScanned': '💬 评论区：扫描 {scanned} 条，发现 {found} 个文件（每帖最多 {max} 条）',
        'bot.legacy.commentsDisabled': '💬 评论区：未启用',
    ...
    en: {
        ...
        'bot.legacy.commentScan': '💬 Comments: scanned {scanned}, found {found} files',
        ...
        'bot.legacy.commentsScanned': '💬 Comments: scanned {scanned}, found {found} files (up to {max} per post)',
        'bot.legacy.commentsDisabled': '💬 Comments: disabled',
